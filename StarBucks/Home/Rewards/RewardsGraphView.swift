...
class RewardsGraphView: UIView {
    ...
    var initialFrameWidth: CGFloat = 200 // arbitrary width
    ...
    func drawRewardsGraph() {
        ...
        // Because Core Graphics straddles its frame when it drwas, and we want a circle
        // exactlt at this point, we need to offst by this amount in the y. The 50
